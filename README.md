...
- **Windows**:
  [NormCap-0.3.12-x86_64-Windows.msi](https://github.com/dynobo/normcap/releases/download/v0.3.12/NormCap-0.3.12-x86_64-Windows.msi)
- **Linux**:
  [NormCap-0.3.12-x86_64.AppImage](https://github.com/dynobo/normcap/releases/download/v0.3.12/NormCap-0.3.12-x86_64.AppImage)
- **macOS**:
  [NormCap-0.3.12-x86_64-macOS.dmg](https://github.com/dynobo/normcap/releases/download/v0.3.12/NormCap-0.3.12-x86_64-macOS.dmg)
  \
